#ifndef SCARA_POSITIONS_H
#define SCARA_POSITIONS_H
...
namespace scara_positions {
    ...
    extern const scara_msgs::msg::PiecePose fourth_piece_pose;
    extern const scara_msgs::msg::PiecePose fifth_piece_pose;
    extern const scara_msgs::msg::PiecePose sixth_piece_pose;
