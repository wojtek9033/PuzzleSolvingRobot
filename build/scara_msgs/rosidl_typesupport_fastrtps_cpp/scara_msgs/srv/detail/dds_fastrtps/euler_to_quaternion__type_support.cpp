...
#include "scara_msgs/srv/detail/euler_to_quaternion__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const scara_msgs::srv::EulerToQuaternion_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  scara_msgs::srv::EulerToQuaternion_Request & ros_message)
{
  // Member: roll
  cdr >> ros_message.roll;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = scara_msgs::srv::EulerToQuaternion_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const scara_msgs::srv::EulerToQuaternion_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<scara_msgs::srv::EulerToQuaternion_Request *>(
    untyped_ros_message);
...
{
  return &scara_msgs::srv::typesupport_fastrtps_cpp::_EulerToQuaternion_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scara_msgs, srv, EulerToQuaternion_Request)() {
  return &scara_msgs::srv::typesupport_fastrtps_cpp::_EulerToQuaternion_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_scara_msgs
cdr_serialize(
  const scara_msgs::srv::EulerToQuaternion_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: x
  cdr << ros_message.x;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  scara_msgs::srv::EulerToQuaternion_Response & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = scara_msgs::srv::EulerToQuaternion_Response;
    is_plain =
      (
      offsetof(DataType, w) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const scara_msgs::srv::EulerToQuaternion_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<scara_msgs::srv::EulerToQuaternion_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &scara_msgs::srv::typesupport_fastrtps_cpp::_EulerToQuaternion_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scara_msgs, srv, EulerToQuaternion_Response)() {
  return &scara_msgs::srv::typesupport_fastrtps_cpp::_EulerToQuaternion_Response__handle;
}
...
// functions for scara_msgs::srv::EulerToQuaternion_Request already declared above

// functions for scara_msgs::srv::EulerToQuaternion_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_scara_msgs
cdr_serialize(
  const scara_msgs::srv::EulerToQuaternion_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      scara_msgs::srv::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  scara_msgs::srv::EulerToQuaternion_Event & ros_message)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      scara_msgs::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        scara_msgs::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        scara_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_EulerToQuaternion_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        scara_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_EulerToQuaternion_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = scara_msgs::srv::EulerToQuaternion_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      scara_msgs::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        scara_msgs::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        scara_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_EulerToQuaternion_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        scara_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_EulerToQuaternion_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const scara_msgs::srv::EulerToQuaternion_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<scara_msgs::srv::EulerToQuaternion_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &scara_msgs::srv::typesupport_fastrtps_cpp::_EulerToQuaternion_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scara_msgs, srv, EulerToQuaternion_Event)() {
  return &scara_msgs::srv::typesupport_fastrtps_cpp::_EulerToQuaternion_Event__handle;
}
...
static const rosidl_service_type_support_t _EulerToQuaternion__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<scara_msgs::srv::EulerToQuaternion_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<scara_msgs::srv::EulerToQuaternion_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<scara_msgs::srv::EulerToQuaternion_Event>(),
...
{
  return &scara_msgs::srv::typesupport_fastrtps_cpp::_EulerToQuaternion__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scara_msgs, srv, EulerToQuaternion)() {
  return &scara_msgs::srv::typesupport_fastrtps_cpp::_EulerToQuaternion__handle;
}
